...
class Ticket05RuntimeTests(unittest.TestCase):
    ...
    def test_k3s_installation_keeps_required_addons_and_disables_only_network_addons(self) -> None:
        ...
        self.assertIn('write-kubeconfig-mode: "0640"', installer)
        self.assertIn('write-kubeconfig-group: "mlops-runtime"', installer)
        self.assertIn("RUNTIME_USER='zeng'", installer)
